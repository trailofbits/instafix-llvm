...
// CHECK-DAG: llvm.mlir.global external hidden @v4(1 : i32)
...
// CHECK-DAG: llvm.mlir.alias external hidden @a3 {dso_local} : i32 {
...
// CHECK-DAG: llvm.func hidden @f3() attributes {dso_local} {
