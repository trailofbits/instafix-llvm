...
// CHECK: cir.global external @i3 = #cir.const_record<{#cir.int<12> : !s32i}> : !rec_anon{{[_0-9a-fE.]*}}

int a[10][10][10];
int *a2 = &a[3][0][8];
struct { int *p; } a3 = {&a[3][0][8]};
// CHECK: cir.global external @a2 = #cir.global_view<@a, [3 : i32, 0 : i32, 8 : i32]> : !cir.ptr<!s32i>
// CHECK: cir.global external @a3 = #cir.const_record<{#cir.global_view<@a, [3 : i32, 0 : i32, 8 : i32]> : !cir.ptr<!s32i>}> : !rec_anon{{[_0-9a-fE.]*}}

int p[10];
int *p1 = &p[0];
struct { int *x; } p2 = {&p[0]};
// CHECK: cir.global external @p1 = #cir.global_view<@p> : !cir.ptr<!s32i>
// CHECK: cir.global external @p2 = #cir.const_record<{#cir.global_view<@p> : !cir.ptr<!s32i>}> : !rec_anon{{[_0-9a-fE.]*}}

int q[10];
int *q1 = q;
struct { int *x; } q2 = {q};
// CHECK: cir.global external @q1 = #cir.global_view<@q> : !cir.ptr<!s32i>
// CHECK: cir.global external @q2 = #cir.const_record<{#cir.global_view<@q> : !cir.ptr<!s32i>}> : !rec_anon{{[_0-9a-fE.]*}}
