...
// CIR:    [[COMPLITERAL_MEM:%.*]] = cir.alloca !rec_anon{{[_0-9a-fE.]*}}, !cir.ptr<!rec_anon{{[_0-9a-fE.]*}}>, [".compoundliteral"] {alignment = 4 : i64}
// CIR:    [[FIELD:%.*]] = cir.get_member [[COMPLITERAL_MEM]][0] {name = "i"} : !cir.ptr<!rec_anon{{[_0-9a-fE.]*}}> -> !cir.ptr<!s32i>
